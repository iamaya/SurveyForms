		...
		com.worklight.wlclient.api.WLResponseListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Worklight.Xamarin.Android.ResponseListener, Worklight.Xamarin.Android, Version=1.0.0.21095, Culture=neutral, PublicKeyToken=null", ResponseListener.class, __md_methods);
	}
	...
	public ResponseListener () throws java.lang.Throwable
	{
		...
		if (getClass () == ResponseListener.class)
			mono.android.TypeManager.Activate ("Worklight.Xamarin.Android.ResponseListener, Worklight.Xamarin.Android, Version=1.0.0.21095, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
