...
namespace WorklightSample
{
	...
	public class SampleClient
	{
		...
		public async Task<WorklightResult> SubscribeAsync(Action<String> callBack)
		{
			var result = new WorklightResult();
		...
		private void SubscribePush(Action<String> callBack)
		{
			Console.WriteLine("Subscribing to push");

			client.PushService.ReadyToSubscribe += (object sender, EventArgs a) =>
			{
